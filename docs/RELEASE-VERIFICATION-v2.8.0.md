# Release Verification Checklist for v2.8.0

This checklist is the minimum release gate for `epi-recorder` v2.8.0 before publishing to PyPI and GitHub.

## Scope

v2.8.0 introduces three release-critical areas:
