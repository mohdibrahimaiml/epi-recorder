...
**Status:** Proposed design for the next enterprise policy layer after `v2.8.7`  
...
`v2.8.7` policy is already useful for sealing a workflow rulebook into a `.epi` artifact and checking a run against it after the fact.
