...
| `INVALID` | Signature invalid or identity revoked | Signature invalid or identity revoked — do not trust |
...
| Reference | URL |
|---|---|
| Agent Governance Toolkit (AGT) | [github.com/microsoft/agent-governance-toolkit](https://github.com/microsoft/agent-governance-toolkit) |
...
| CycloneDX 1.5 Specification | [cyclonedx.org/specification/overview](https://cyclonedx.org/specification/overview/) |
| SCITT IETF Draft | [datatracker.ietf.org/doc/draft-ietf-scitt-architecture](https://datatracker.ietf.org/doc/draft-ietf-scitt-architecture/) |
| EU AI Act (Regulation 2024/1689), Article 12 | [eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) |
