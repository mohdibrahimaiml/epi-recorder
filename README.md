...
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/LICENSE)
...
> Policy / “did the run break our rules?” is separate again: `epi analyze` — see [docs/POLICY-AND-FAULT-ANALYZER.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/POLICY-AND-FAULT-ANALYZER.md).
...
Samples: [docs/assets/SAMPLES.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/assets/SAMPLES.md) · try `docs/assets/readme-demo.epi`.
...
More: [docs/FRAMEWORK-INTEGRATIONS-5-MINUTES.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/FRAMEWORK-INTEGRATIONS-5-MINUTES.md)
...
Policy + fault analyzer guide: [docs/POLICY-AND-FAULT-ANALYZER.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/POLICY-AND-FAULT-ANALYZER.md)
...
| Topic | Link |
|-------|------|
| **Docs map** | [docs/README.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/README.md) |
| **Guided pilot pack** | [docs/PILOT.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/PILOT.md) |
| Enterprise in 15 minutes | [docs/ENTERPRISE-15-MINUTES.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/ENTERPRISE-15-MINUTES.md) |
| Enterprise capability (honest) | [docs/ENTERPRISE-CAPABILITY.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/ENTERPRISE-CAPABILITY.md) |
| Policy + fault analyzer | [docs/POLICY-AND-FAULT-ANALYZER.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/POLICY-AND-FAULT-ANALYZER.md) |
| Known limitations | [docs/KNOWN_LIMITATIONS.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/KNOWN_LIMITATIONS.md) |
| CLI deep dive | [docs/CLI.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/CLI.md) |
| Auditors guide | [docs/AUDITORS-GUIDE.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/AUDITORS-GUIDE.md) |
...
| Topic | Docs |
|-------|------|
| EU AI Act Annex IV | [docs/ANNEX-IV.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/ANNEX-IV.md) |
| AIUC-1 domains | [docs/standards/aiuc-1-evidence.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/standards/aiuc-1-evidence.md) |
| SCITT | [docs/standards/scitt-predicate.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/standards/scitt-predicate.md) |
...
| `docs/` | Start at [docs/README.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/README.md) |
| `tests/test_core_loop_golden.py` | Golden path regression |

Website edits: only under `website/`, then `python scripts/sync_website.py`. See [docs/archive/SITE.md](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/docs/archive/SITE.md).

---

## License

MIT — see [LICENSE](https://github.com/mohdibrahimaiml/epi-recorder/blob/v4.4.6/LICENSE).
